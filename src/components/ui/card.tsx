...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'group/card flex flex-col gap-(--card-spacing) overflow-hidden rounded-2xl bg-oklch(1 0 0) py-(--card-spacing) text-sm text-oklch(0.141 0.005 285.823) ring-1 ring-oklch(0.141 0.005 285.823)/10 [--card-spacing:--spacing(6)] has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(4)] *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl dark:bg-oklch(0.21 0.006 285.885) dark:text-oklch(0.985 0 0) dark:ring-oklch(0.985 0 0)/10',
        className,
      )}
      {...props}
    />
