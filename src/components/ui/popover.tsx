  ...
  return (
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        className={cn(
          'z-50 flex w-72 origin-(--radix-popover-content-transform-origin) flex-col gap-4 rounded-2xl bg-oklch(1 0 0) p-4 text-sm text-oklch(0.141 0.005 285.823) shadow-2xl ring-1 ring-oklch(0.141 0.005 285.823)/5 outline-hidden duration-100 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 dark:bg-oklch(0.21 0.006 285.885) dark:text-oklch(0.985 0 0) dark:ring-oklch(0.985 0 0)/5',
          className,
        )}
        {...props}
      />
