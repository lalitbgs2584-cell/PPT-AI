...
function RadioGroupItem({
  ...
  return (
    ...
    >
      ...
      >
        <span className="absolute top-1/2 left-1/2 size-2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-oklch(0.985 0 0) dark:bg-oklch(0.21 0.006 285.885)" />
      </RadioGroupPrimitive.Indicator>
    </RadioGroupPrimitive.Item>
  )
}
