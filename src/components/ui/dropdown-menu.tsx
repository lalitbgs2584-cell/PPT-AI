  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        align={align}
        className={cn(
          'z-50 max-h-(--radix-dropdown-menu-content-available-height) w-(--radix-dropdown-menu-trigger-width) min-w-48 origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-2xl bg-oklch(1 0 0) p-1 text-oklch(0.141 0.005 285.823) shadow-2xl ring-1 ring-oklch(0.141 0.005 285.823)/5 duration-100 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=closed]:overflow-hidden dark:ring-oklch(0.141 0.005 285.823)/10 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 dark:bg-oklch(0.21 0.006 285.885) dark:text-oklch(0.985 0 0) dark:ring-oklch(0.985 0 0)/5 dark:dark:ring-oklch(0.985 0 0)/10',
          className,
        )}
        {...props}
      />
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        'ml-auto text-xs tracking-widest text-oklch(0.552 0.016 285.938) group-focus/dropdown-menu-item:text-oklch(0.21 0.006 285.885) dark:text-oklch(0.705 0.015 286.067) dark:group-focus/dropdown-menu-item:text-oklch(0.985 0 0)',
        className,
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-default items-center gap-2 rounded-xl px-3 py-2 text-sm outline-hidden select-none focus:bg-oklch(0.967 0.001 286.375) focus:text-oklch(0.21 0.006 285.885) not-data-[variant=destructive]:focus:**:text-oklch(0.21 0.006 285.885) data-inset:pl-9.5 data-open:bg-oklch(0.967 0.001 286.375) data-open:text-oklch(0.21 0.006 285.885) [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 dark:focus:bg-oklch(0.274 0.006 286.033) dark:focus:text-oklch(0.985 0 0) dark:not-data-[variant=destructive]:focus:**:text-oklch(0.985 0 0) dark:data-open:bg-oklch(0.274 0.006 286.033) dark:data-open:text-oklch(0.985 0 0)",
        className,
      )}
      {...props}
    >
