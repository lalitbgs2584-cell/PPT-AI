...
function ButtonGroupText({
  ...
  return (
    <Comp
      className={cn(
        "flex items-center gap-2 rounded-4xl border border-oklch(0.92 0.004 286.32) bg-oklch(0.967 0.001 286.375) px-2.5 text-sm font-medium [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 dark:border-oklch(1 0 0 / 10%) dark:bg-oklch(0.274 0.006 286.033)",
        className,
      )}
      {...props}
    />
...
function ButtonGroupSeparator({
  ...
  return (
    <Separator
      ...
      className={cn(
        'relative self-stretch bg-oklch(0.92 0.004 286.32) data-horizontal:mx-px data-horizontal:w-auto data-vertical:my-px data-vertical:h-auto dark:bg-oklch(1 0 0 / 15%)',
        className,
      )}
      {...props}
    />
