...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root
      ...
      data-size={size}
      className={cn(
        'group/avatar relative flex size-8 shrink-0 rounded-full select-none after:absolute after:inset-0 after:rounded-full after:border after:border-oklch(0.92 0.004 286.32) after:mix-blend-darken data-[size=lg]:size-10 data-[size=sm]:size-6 dark:after:mix-blend-lighten dark:after:border-oklch(1 0 0 / 10%)',
        className,
      )}
      {...props}
    />
...
function AvatarBadge({ className, ...props }: React.ComponentProps<'span'>) {
  return (
    <span
      ...
      className={cn(
        'absolute right-0 bottom-0 z-10 inline-flex items-center justify-center rounded-full bg-oklch(0.21 0.006 285.885) text-oklch(0.985 0 0) bg-blend-color ring-2 ring-oklch(1 0 0) select-none dark:bg-oklch(0.92 0.004 286.32) dark:text-oklch(0.21 0.006 285.885) dark:ring-oklch(0.141 0.005 285.823)',
