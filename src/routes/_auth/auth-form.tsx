...
import { ArrowRight, GithubLogoIcon, GoogleLogoIcon } from '@phosphor-icons/react'
        ...
        {providerButtons.map((providerButton) => {
          ...
          return (
            ...
            >
              ...
              <ArrowRight className="size-4 text-neutral-500 transition-all group-hover:translate-x-0.5 group-hover:text-[var(--primary)]" />
            </Button>
          )
        })}
      </CardContent>
